...
Get-NetIPAddress
New-NetIPAddress -InterfaceIndex 16 -IPAddress 10.13.10.12 -PrefixLength 24 -DefaultGateway 10.13.10.20
Restart-Computer
...
Add-DhcpServerInDC -DnsName $DNSNAME -IPAddress 10.13.10.12
